# Langtons-Ant
It is a simulation of an Ant following some specific set of rules for it's movement across a grid.
...
behave weirdly. These are the specifications of the simulation you need to code:
